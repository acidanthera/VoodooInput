//
//  MultitouchDigitiserTransducer.cpp
//
//  Created by Alexandre on 13/09/2017.
//  Copyright © 2017 Alexandre Daoud. All rights reserved.
//

#ifndef DIGITISER_TRANSDUCER_HPP
#define DIGITISER_TRANSDUCER_HPP
...
class MultitouchDigitiserTransducer : public OSObject {
    OSDeclareDefaultStructors(MultitouchDigitiserTransducer);
